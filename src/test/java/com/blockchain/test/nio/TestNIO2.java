...
public class TestNIO2 {
    ...
    public void test8() {
        try (FileChannel inChannel = FileChannel.open(Paths.get("1.jpg"), StandardOpenOption.READ);
             FileChannel outChannel = FileChannel.open(Paths.get("21.jpg"), StandardOpenOption.WRITE, StandardOpenOption.CREATE)) {

            ByteBuffer buf = ByteBuffer.allocate(60240);
            inChannel.read(buf);
            buf.flip();
    ...
    public void test6() throws IOException {
        Path path = Paths.get("E:/ML/myDatabase/jvm.md");
...
//		System.out.println(newPath);
    ...
    public void test1() {
        ...
        System.out.println(path.endsWith("jvm.md"));
